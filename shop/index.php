            ...
            <div class="sidebar">
              <div class="widget">
                ...
                <li><a href="?">All</a>
                  ...
                  <li><a href="?cat=Fassion">Fassion</a>
                  </li>
                  <li><a href="?cat=Electronic">Electronic</a>
                  </li>
                  <li><a href="?cat=Home">Home & Kitchen</a>
                  </li>
          ...
          <div class="col-md-9">
            ...
            <div class="container-fluid">
              ...
              <?php 
                 ...
                 if (isset($_GET['s'])){
                  $search = $_GET['s'];
                  $products = connect()->query("SELECT * FROM products WHERE name LIKE '%$search%'");
                }
                ...
                <div class="col-md-4 col-sm-6">
                  <div class="shop-product">
                    ...
                    <div class="product-info">
                      <h4 class="upper"><a href="#"><?php echo $product->name ?></a></h4><span>$<?php echo $product->price ?></span>
